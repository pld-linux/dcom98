...
DCOM (Distributed Component Object Model) to protokół pozwalający
komponentom programowym komunikować się bezpośrednio po sieci w pewny,
bezpieczny i wydajny sposób. Znany wcześniej jako "sieciowe OLE", DCOM
został zaprojektowany do używania poprzez wiele sieciowych warstw
transportowych, w tym protokołów internetowych takich jak HTTP. DCOM
jest oparty na specyfikacji DCE-RPC Open Software Foundation i działa
zarówno z apletami Javy, jak i komponentami ActiveX(R) dzięki
